...
import com.example.sahan.guideme.connection.ApiUtils;
...
LocationListener{
    ...
    public void onLocationChanged(Location location) {
        ...
        sendLocation("001",android_id,latitude,longitude);
    ...
    private void sendLocation(String s, String hotelFindersDID, double latitude, double longitude) {
        ...
        model.setLng(String.valueOf(longitude));
        mAPIService.saveLocation(model).enqueue(new Callback<Model>() {
            @Override
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.Search:
                ...
                String url = getUrl(latitude, longitude, hotels);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;
